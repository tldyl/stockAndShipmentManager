...
Private Sub Text1_DblClick(Index As Integer)
    ...
    Case 1
        ...
        If AdoUnits.Recordset.RecordCount > 0 Then
            DataGrid2.Visible = True   '使 控件 可见
    ...
    If KeyCode = 13 Then
        ...
        Case 1:
            ...
            If AdoUnits.Recordset.RecordCount > 0 Then
                ...
                If DataGrid2.Visible Then DataGrid2.SetFocus   '使控件获得焦点
            Else
                AdoUnits.RecordSource = "select * from tbS_units "   '执行SQL语句
                AdoUnits.Refresh
                DataGrid2.Visible = True
                If DataGrid2.Visible Then DataGrid2.SetFocus   '使控件获得焦点
            End If
        Case 2:
            AdoEmploy.RecordSource = "select * from tbS_employ where fullname like'" + Text1(2).Text + "%'"  '执行SQL语句
            AdoEmploy.Refresh
            If AdoEmploy.Recordset.RecordCount > 0 Then
                DataGrid1.Visible = True
                If DataGrid1.Visible Then DataGrid1.SetFocus   '使控件获得焦点
            Else
                AdoEmploy.RecordSource = "select * from tbS_employ "  '执行SQL语句
                AdoEmploy.Refresh
                DataGrid1.Visible = True
                If DataGrid1.Visible Then DataGrid1.SetFocus   '使控件获得焦点
            End If
